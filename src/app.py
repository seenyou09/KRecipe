...
# image = Image.open("/Users/seanyoo/Desktop/KRecipe/image/maangchi_pic.png").resize((200, 150))
# st.image(image)

image = Image.open("/Users/seanyoo/Desktop/KRecipe/image/bimb.png").resize((750,421))
st.image(image)
